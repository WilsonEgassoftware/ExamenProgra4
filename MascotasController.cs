...
namespace ExamenProgreso1_EgasW.Controllers
{
    public class MascotasController : Controller
    {
        ...
        public MascotasController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,nombre,raza,fechaNacimiento,Genero,idPropietario")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nombre,raza,fechaNacimiento,Genero,idPropietario")] Mascota mascota)
        {
            if (id != mascota.Id)
            {
                return NotFound();
